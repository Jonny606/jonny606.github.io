...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=373349');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "373349");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "824adfbf0e2de722dcc40e6493ba0401ee161b1d0a1594545b50c4f4114a61a0");
define('CREATED_TIMESTAMP', "1760123911");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor373349');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor373349');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "nin104.global.ssl.fastly.net",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "nin104.global.ssl.fastly.net",
));
